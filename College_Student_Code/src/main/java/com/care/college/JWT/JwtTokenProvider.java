...
import com.care.college.student.StudentDTO_Student;
...
public class JwtTokenProvider {
    ...
    // 토큰 생성
    public String generateJwtToken(StudentDTO_Student StudentDto) {
    	System.out.println(Base64.getEncoder().encodeToString(secretKey.getBytes()));
    	JwtBuilder accessToken = Jwts.builder()
    			.setHeader(createHeader())                              	// Header 구성
    			.setClaims(createClaims(StudentDto))                       	// Payload - Claims 구성
    			.setSubject(String.valueOf(StudentDto.getStudent_No()))   	// Payload - Subject 구성
...
public String getTokenFromHeader(String header) {
     ...
     *
     * @param StudentDTO_Student 사용자 정보
     * @return Map<String, Object>
     */
    private Map<String, Object> createClaims(StudentDTO_Student StudentDto) {

        Map<String, Object> claims = new HashMap<>();

        log.info("Name :" + StudentDto.getName());

        claims.put("Name", StudentDto.getName());
        return claims;
    }
    /**
