...
<body>
	<table class="table">
		...
		<tr>
			...
			<td>
				<div class="button">
					<p class="btnText">학생 정보 수정</p>
					<div class="btnTwo"
						onclick="location.href='/student/student_update?student_No=${student.student_No}'">
			...
			<td>
				<div class="button">
					...
					<div class="btnTwo" onclick="deleteCheck('${student.student_No}')">
	...
	<button class="custom-btn btn-5" onclick="location.href='/student/admin_index'">
		<span>이전으로 가기</span>
	</button>
</body>
<style>
