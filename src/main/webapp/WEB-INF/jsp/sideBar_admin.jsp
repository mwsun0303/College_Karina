...
<body class="main">
	...
	<div class="wrap-container">
		<div class="nav">
			...
			<tr>
				<td id="login_Name">관리자</td>
				<td align="right"><button onclick="logout()" class="logoutBt">로그아웃</button></td>
			</tr>
			</table>
				<ul class="nav-menu">				
					<li class="has-child is-opened"><span class="">학과 관리</span>
						<ul style="display: block;">
							<li id="menu_hakbu"><span onclick="location.href='department_regist'">학과 등록</span></li>
							<li><span onclick="location.href='department_list'" id="menu_stdno" class="">학과 목록 보기</span></li>
						</ul>
					</li>
					<li class="has-child is-opened"><span class="">교수 관리</span>
						<ul style="display: block;">
							<li id="menu_hakbu"><span onclick="location.href='professor_regist'">교수 등록</span></li>
							<li><span onclick="location.href='professor_list'">교수 목록 보기</span></li>
						</ul>
					</li>
					<li class="has-child is-opened"><span class="">학생 관리</span>
						<ul style="display: block;">
							<li id="menu_hakbu"><span onclick="location.href='student_regist'">학생 등록</span></li>
							<li><span onclick="location.href='student_list'">학생 목록 보기</span></li>
						</ul>
					</li>
					<li class="has-child is-opened"><span class="">강의 관리</span>
						<ul style="display: block;">
							<li id="menu_hakbu"><span onclick="location.href='subject_regist'">강의 등록</span></li>
							<li><span onclick="location.href='subject_list'">강의 목록 보기</span></li>
						</ul>
					</li>
